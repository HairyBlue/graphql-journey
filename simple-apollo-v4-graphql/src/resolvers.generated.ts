...
export type PublicUserResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["PublicUser"] = ResolversParentTypes["PublicUser"],
> = {
...
> = {
  testimonial?: Resolver<
    ReadonlyArray<ResolversTypes["Testimonial"]>,
    ParentType,
    ContextType
  >;
  user?: Resolver<
    ReadonlyArray<ResolversTypes["PublicUser"]>,
    ParentType,
    ContextType,
    RequireFields<QueryRootUserArgs, "where">
  >;
  users?: Resolver<
    ReadonlyArray<ResolversTypes["PublicUser"]>,
    ParentType,
